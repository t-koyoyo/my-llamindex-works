...
# ------------------------------
# ■ Requirements
# https://gpt-index.readthedocs.io/en/v0.8.0/examples/vector_stores/QdrantIndexDemo.html
# ------------------------------
...
client = qdrant_client.QdrantClient(path='../storages/vector_store/qdrant')
...
# ■ Save index
# ------------------------------
index.storage_context.persist('../storages/vector_store/qdrant')